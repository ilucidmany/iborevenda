...
if ($logoans != NULL) {
    ...
    echo "          <img class=\"img-profile rounded-circle\" width=\"65px\" src=\"img/ic_launcher_foreground.png\">" . "\n";
    echo "        </div>\n";
} else {
    echo "      <!-- Sidebar - Brand -->\n      <a class=\"sidebar-brand d-flex align-items-center justify-content-center\" href=\"users.php\">\n        <div class=\"sidebar-brand-icon\">\n          <img class=\"img-profile rounded-circle\" width=\"65px\" src=\"img/logo.png\">\n        </div>\n";
}
echo "\n      </a>\n\n      <!-- Divider -->\n      <hr class=\"sidebar-divider my-0\">\n\n      <!-- Nav Item -->\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"users.php\">\n          <i class=\"fas fa-fw fa-user-plus\"></i>\n";
echo "          <span>Usuários (" . $mac_count . ")</span></a></li>";
?>
...
<!-- <li class="nav-item">
    <a class="nav-link" href="stores_mac.php">
    <i class="fas fa-fw fa-store"></i>
    <span>Stores MAC</span></a>
</li>
<li class="nav-item">
...
echo "<div><h5 class=\"m-0 text-primary\">IBO VU REVENDA<br>" . $nameans . " </br></h5></div>" . "\n";
