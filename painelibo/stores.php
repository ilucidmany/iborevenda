...
while ($row = $res->fetchArray()) {
    ...
    echo '<td><a class="btn btn-icon" href="javascript:void(0);" onclick="confirmDelete(' . $id . ')"><span class="icon text-white-50"><i class="fa fa-trash" style="font-size:24px;color:red"></i></span></a></td>' . "\n";
    echo "\t\t\t\t</tr>\n\t\t\t</tbody>\n";
}
echo "\t\t\t</table>\n\t\t</div>\n</main>\n\n    <br><br><br>\n";
