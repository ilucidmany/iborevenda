...
function loadIbo(){
    $app_info_json = file_get_contents('./update.json');
...
$mac_address = substr(preg_replace('/[^a-fA-F0-9]/', '', $mac_address), 0, 12); // Remove caracteres não hexadecimais e pega os primeiros 12 caracteres
$mac_address = strtoupper(chunk_split($mac_address, 2, ':'));
