...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-1 text-gray-800"> Create Store</h1>

    <!-- Custom codes -->
    <div class="card border-left-primary shadow h-100 card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user"></i> Edit Store</h6>
        </div>
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-group ">
                    ...
                    <div class="input-group">
                        <input class="form-control text-primary" name="name" placeholder="Enter store name" type="text" required/>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control text-primary" name="username" placeholder="Enter store username" type="text" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control text-primary" name="password" placeholder="Enter store password" type="password" required />
                    </div>
                </div>
